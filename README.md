# GIT
Привет! Здесь о том, как я училась разбираться в GIT и работать в bash в рамках интенсива от "Школы седого тестировщика" и курса "Тестировщик с нуля" Артёма Русова.
