...
>Добавление файла без индексации, то есть пропуская этот этап, он автоматически проиндексируется. ***Это работает только с теми файлами, которые уже были проиндексированы когда-то. С новыми - нет.***
>
...
>
>***Опция -f игнорирует все предупреждения гита***
>
...
```git branch -v```
>Более детальная инф-я о ветках
>
