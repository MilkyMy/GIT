...
```git commit -am```
>Индексация и комит уже подготовленного к комиту, но изменённого файла file3.txt. Он добавит только те файлы, которые уже были проиндексированы когда-то. Новые - нет.
